...
public class Film implements Serializable {
	...
	private long id;
	@NotBlank
	@Size(max=250, message = "le titre a au maximum 250 caracteres")
	private String titre;

	@Min(value = 1900, message = "l'annee minimum du film est 1900")
	private int annee;
	@Min(value = 1, message = "la durée est supérieure à 1 minute")
	private int duree;
	@Size(min=20, max=250, message = "le synopsis doit faire entre 20 et 250 caracteres")
